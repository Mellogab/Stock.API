...
namespace Stock.Core.Entities
{
    ...
    {
        public Stock() { }
        public Stock(string Paper, decimal Quotation, decimal PEBIT, decimal EVEBIT, decimal EVEBITDA, decimal VolumeTraded, decimal DividendYield, decimal ROIC, decimal ROE, decimal NetEquity)
        {
            this.Paper = Paper;
